CREATE OR REPLACE PACKAGE PKG_DEMO IS
  ...
  *********************************************************************/
  ...
  FUNCTION FUNC_IS_RED_TOTAL_AMT_NOTEQ RETURN BOOLEAN;
  FUNCTION FUNC_IS_APPL_MORE_THEN_FIVE(V_MSG OUT VARCHAR2) RETURN BOOLEAN;
  function FUNC_IS_EXPERT_LCR(I_INVEST_ID in varchar2) return boolean;
END PKG_DEMO;
/
