create or replace type unex_prod_info as object
(
-- Purpose : 净值报价产品
  ...
  member PROCEDURE PROC_DEAL_POP_UNEX(o_flag in out number,
...
create or replace type body unex_prod_info is
  ...
  begin
    ...
    pkg_demo.PROC_DEAL_POP_UNEX_EMP_AND_CO(self.invest_id);
